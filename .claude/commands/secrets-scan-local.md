...
### 3. Save output
Filename: `<repo-name>-<branch>-secrets-scan-local-YYYY-MM-DD.docx` (or with sanitized target)
...
python3 ~/.claude/scripts/md_to_docx.py /tmp/secrets_local_${TIMESTAMP}.md "${REPO_ROOT}/${REPO_NAME}-${BRANCH}-<filename>.docx"

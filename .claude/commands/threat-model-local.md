...
- No target: `<repo-name>-<branch>-threat-model-local-YYYY-MM-DD.docx`
- Named target: `<repo-name>-<branch>-threat-model-local-<sanitized-target>-YYYY-MM-DD.docx` (lowercase, spaces → hyphens)

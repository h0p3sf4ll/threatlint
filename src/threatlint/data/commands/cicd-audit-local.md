...
### 3. Save output
Filename: `<repo-name>-<branch>-cicd-audit-local-YYYY-MM-DD.docx` (or with sanitized target)
...
python3 ~/.claude/scripts/md_to_docx.py /tmp/cicd_local_${TIMESTAMP}.md "${REPO_ROOT}/${REPO_NAME}-${BRANCH}-<filename>.docx"

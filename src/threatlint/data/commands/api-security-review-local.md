...
### 3. Save output
Filename: `<repo-name>-<branch>-api-security-review-local-YYYY-MM-DD.docx` (or with sanitized target)
...
python3 ~/.claude/scripts/md_to_docx.py /tmp/api_local_${TIMESTAMP}.md "${REPO_ROOT}/${REPO_NAME}-${BRANCH}-<filename>.docx"
